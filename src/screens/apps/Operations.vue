  ...
  <MainLayout class="pb-0">
    <div class="flex flex-col pt-12 md:pt-22 min-h-[calc(100vh-69px)] text-slate-800 relative">
      <div class="flex flex-col max-w-220 mx-auto pb-120 text-center">
        ...
        <header class="text-xl md:text-7xl leading-tight font-light font-serif mt-2">
          The Easiest Way to <br /> Start Mining and Vaulting
        </header>

        <p class="text-lg px-10 mt-5">
        ...
        <div class="flex flex-row items-center justify-center gap-x-5 mt-14">
          ...
          <a href="#all-downloads" class="flex flex-row items-center justify-center gap-3  border border-argon-800 text-argon-600 rounded-md md:text-2xl w-5/12 px-2 py-2 md:py-3 font-bold cursor-pointer whitespace-nowrap hover:bg-argon-300/15" style="box-shadow: inset 1px 1px 0 rgba(255, 255, 255, 0.5), 1px 1px 0 rgba(255, 255, 255, 1);">
      ...
      <img src="/app-operations.png" alt="Argon Operations App" class="absolute top-full -translate-y-100 w-8/12 left-1/2 -translate-x-1/2" />
    </div>
