  ...
  <MainLayout>
    <div class="mt-12 md:mt-22 max-w-220 mx-auto text-slate-800 px-4">
      <h1 class="text-2xl md:text-[3.5rem] md:leading-20 font-semibold text-slate-700">
        Argon’s Secret Launch Plan
      </h1>
      <div class="text-xl md:text-4xl font-light border-y border-gray-300 py-4 mt-2">
        Our Path to Becoming a Trillion Dollar Stablecoin
      </div>
      ...
      <div class="flex flex-col gap-5 mx-auto text-lg mt-6 md:mt-12 font-light">
        ...
        <p>
          Almost everyone
          has a dollar, and so, naturally, almost everyone uses it. According to the Bank for International Settlements,
          between 88-90% of all financial transactions globally use the dollar on at least one side of the trade. Even in
          the crypto space, the dollar reigns supreme &ndash; over 99% of all stablecoins are pegged to the dollar.
        </p>
      ...
      <div class="flex flex-col gap-2 mt-5 pb-10">

        <div PhasesContainer class="flex flex-col gap-5 py-10 mb-20" style="box-shadow: inset 1px 0 0 rgba(255, 255, 255, 0.2), 1px 1px 0 rgba(255, 255, 255, 0.2);">
          <div PhaseContainer>
            <div Top>
              <div Calendar>
                <div Month>Jan</div>
          ...
          <div PhaseContainer class="mt-10">
            <div Top>
              <div Calendar>
                <div Month>Mar</div>
                <div Day>17</div>
            ...
            <div Content>
              ...
              <p>
                This phase is solely focused on internal improvement, but we believe it's critical to Argon's long-term success.
...
[PhaseContainer] {
  ...
  h2 {
    ...
    [Title] {
      @apply text-2xl md:text-4xl font-bold mt-2 md:leading-14 -ml-px border-t border-gray-300;
    }
  }
  [EstimatedTimeframe] {
    @apply text-lg font-light mt-3 py-2 border-y border-gray-300;
  }
  [Content] {
    @apply flex flex-col gap-5 mt-7 text-lg;
  }
}
</style>