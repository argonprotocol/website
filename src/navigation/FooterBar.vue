...
<!--        </div>-->
    ...
    <div BottomBar class="py-3 flex flex-row px-5 md:px-5 whitespace-nowrap">
      ...
      <div Icons class="flex flex-row gap-x-3">
        <a href="https://x.com/argonnetwork/"target="_blank"><XIcon class="w-[19px]  mx-auto mr-1 relative top-[2px]" /></a>
        <a href="https://argonnetwork.substack.com/"target="_blank"><SubstackIcon class="w-[21px] hover:text-white mx-auto mr-1 relative top-[2px]" /></a>
        <a href="https://discord.gg/argonnetwork" target="_blank"><DiscordIcon class="relative top-[1px] w-6 h-6  mx-auto" /></a>
